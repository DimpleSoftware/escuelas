...
<body>
	...
	<form enctype="multipart/form-data" method="post" id="formAgregarDatosEscuela" name="formAgregarDatosEscuela">
		...
		<div class="form-group">
        <label>DNI Director: *</label><input class="form-control"  name="dniDirector" value="<?php echo $nombreDirector?>">
        </div>
		...
		<div class="form-group">
        <label>NumeroEscuela: *</label><input class="form-control"  name="numeroEscuela" value="<?php echo $numeroEscuela?>">
        </div>

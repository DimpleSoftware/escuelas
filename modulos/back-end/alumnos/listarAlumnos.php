...
<?php
	...
	$_alumnos = $alu1->listarAlumnos($offset,$limit,$campoOrder,$order);	
...
<body>
	...
	if(count($_alumnos)){?>	
		...
		{
		$marcaTransi = $_alumnos[$i]['MarcaNetbook'];
		$serie = $_alumnos[$i]['numSerie'];
		$_marca = $mar1->listarMarca($marcaTransi);
		$marca = $_marca['nombre'];
		$color= "black";
		}

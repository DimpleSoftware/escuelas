...
<div id="main" >
	...
	<h3 style="margin-left:125px;">Enmienda Migracion Alumno</h3>
	...
	<form  action="<?php echo $httpHostSitio?>modulos/back-end/migraciones/enmienda.php" method="post" enctype="multipart/form-data" target="_blank">
		...
		<fieldset>
		<legend> Enmienda Migracion Alumno</legend>	
		...
		<!--submit-->
		<a href="javascript:void(0);" onclick="javascript:window.open('formMigracionTransferir.php?datosEscuela=<?php for($i=1;$i<=count($_escuelas);$i++){
			echo $_escuelas[$i]['id'];}?> , '_blank'); window.open('enmienda.php', '_blank'); ">
<input type="submit" value="Agregar"></a> * Campos obligatorios 

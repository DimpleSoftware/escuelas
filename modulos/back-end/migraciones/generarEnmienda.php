        ...
        <div id="page-wrapper">
            ...
            <!-- Page Heading -->
              ...
              <p>
	                    ...
	                    <button type="button" class="btn btn-success" onclick="window.open('<?php echo $httpHostSitio?>modulos/back-end/migraciones/migracionTransferirAlumno.php')" href=<?php echo $httpHostSitio?>modulos/back-end/migraciones/generarEnmienda.php>Enmienda Migracion </button> 	                    
